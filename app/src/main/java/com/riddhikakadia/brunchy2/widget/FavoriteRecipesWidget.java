package com.riddhikakadia.brunchy2.widget;
...
import com.riddhikakadia.brunchy2.ui.FavoriteRecipesActivity;
...
public class FavoriteRecipesWidget extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Constants.ACTION_DATA_UPDATED)) {
